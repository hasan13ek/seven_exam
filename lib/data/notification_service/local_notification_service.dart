...
// Android
  ...
  void showNotification({
    ...
    flutterLocalNotificationsPlugin.show(
      id,
      title,
      "Bu Local Notification Example ID:$id",
      NotificationDetails(
  ...
  void showNotificationAndFireBase({
    required int id,
  }) {
    flutterLocalNotificationsPlugin.show(
      id,
      "Sziga Notification keldi",
      "Oxoh boling ertaklar yaxshilikga yetaklar",
      NotificationDetails(
        android: AndroidNotificationDetails(
          androidNotificationChannel.id,
          androidNotificationChannel.name,
  ...
  void showPeriodically({required int id,required String title}) async {
